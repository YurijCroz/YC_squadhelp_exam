const actionTypes = {
  ...
  GET_MODERATION_ACTION_REQUEST: "GET_MODERATION_ACTION_REQUEST",
  GET_MODERATION_ACTION_SUCCESS: "GET_MODERATION_ACTION_SUCCESS",
  GET_MODERATION_ACTION_ERROR: "GET_MODERATION_ACTION_ERROR",
  ...
  GET_CONTEST_BY_ID_FOR_MODERATOR_ACTION: "GET_CONTEST_BY_ID_FOR_MODERATOR_ACTION",
  GET_CONTEST_BY_ID_FOR_MODERATOR_REQUEST: "GET_CONTEST_BY_ID_FOR_MODERATOR_REQUEST",
  GET_CONTEST_BY_ID_FOR_MODERATOR_SUCCESS: "GET_CONTEST_BY_ID_FOR_MODERATOR_SUCCESS",
  GET_CONTEST_BY_ID_FOR_MODERATOR_ERROR: "GET_CONTEST_BY_ID_FOR_MODERATOR_ERROR",
  CLEAR_CONTEST_BY_ID_FOR_MODERATOR: "CLEAR_CONTEST_BY_ID_FOR_MODERATOR",
  GET_OFFERS_FOR_MODERATOR: "GET_OFFERS_FOR_MODERATOR",
  ...
  CLEAR_MODERATION_LIST: "CLEAR_MODERATION_LIST",
  ...
  SET_NEW_MODERATION_FILTER: "SET_NEW_MODERATION_FILTER",
  SET_STATUS_MODERATION_FILTER: "SET_STATUS_MODERATION_FILTER",
  ...
  MODERATION_CONTEST_ACTION: "MODERATION_CONTEST_ACTION",
  MODERATION_CONTEST_REQUEST: "MODERATION_CONTEST_REQUEST",
  MODERATION_CONTEST_SUCCESS: "MODERATION_CONTEST_SUCCESS",
  MODERATION_CONTEST_ERROR: "MODERATION_CONTEST_ERROR",
  BACK_TO_MODERATION_LIST: "BACK_TO_MODERATION_LIST",
  MODERATION_OFFER_ACTION: "MODERATION_OFFER_ACTION",
  MODERATION_OFFER_ERROR: "MODERATION_OFFER_ERROR",
  MODERATION_LIST_REFRESH: "MODERATION_LIST_REFRESH",
  SET_LOCAL_STORAGE_EVENTS: "SET_LOCAL_STORAGE_EVENTS",
  GET_LOCAL_STORAGE_EVENTS: "GET_LOCAL_STORAGE_EVENTS",
  GET_LOCAL_STORAGE_EVENTS_SUCCESS: "GET_LOCAL_STORAGE_EVENTS_SUCCESS",
  SET_IS_RENDER_HEADER: "SET_IS_RENDER_HEADER",
  SET_IS_RENDER_FOOTER: "SET_IS_RENDER_FOOTER",
};
